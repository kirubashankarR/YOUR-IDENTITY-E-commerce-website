...
export default function WithoutLaminationPage() {
  const products = [
    {
      id: "1",
      title: "Without Lamination Single Side 500",
      description: "GST Inclusive | Qty : 500 | Art Board (300 GSM) | 4C+0 Single Side Printing | Without Lamination | File Upload Size : 90mm x 53mm",
    ...
    {
      id: "2",
      title: "Without Lamination Single Side 1000",
      description: "GST Inclusive | Qty : 1000 | Art Board (300 GSM) | 4C+0 Single Side Printing | Without Lamination | File Upload Size : 90mm x 53mm",
      image: "/placeholder.jpg",
      price: "Rs 500.00",
    ...
    {
      id: "3",
      title: "Without Lamination Front & Back 1000",
      description: "GST Inclusive | Qty : 1000 | Art Board (300 GSM) | 4C+4C Front & Back Printing | Without Lamination | File Upload Size : 90mm x 53mm",
      image: "/placeholder.jpg",
      price: "Rs 550.00",
      delivery: "1 to 7 Business Days",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-card border-b border-border">
        <div className="container mx-auto px-4 py-4">
          <nav className="text-sm text-muted-foreground">
            ...
            <span className="mx-2">/</span>
            <span className="text-foreground">Without Lamination</span>
          </nav>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-2xl font-bold text-gray-800 mb-8">WITHOUT LAMINATION</h1>
                ...
                <div className="flex flex-col sm:flex-row">
                  ...
                  <div className="flex-1 p-3 sm:p-4">
                    ...
                    <div className="border-t border-gray-200 pt-4">
                      <AddToCartButton
                        id={`without-lam-${product.id}`}
                        title={product.title}
                        price={product.price}
                        category="Visiting Cards - Without Lamination"
                      />
                    </div>
                  </div>
                </div>
